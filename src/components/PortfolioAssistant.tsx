    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: '1',
            type: 'bot',
            text: "Hi there! I'm Nishar Ahamed's AI Assistant. Ask me anything about his WMS expertise, React/Next.js skills, open-source packages, or professional background!",
            timestamp: new Date()
        }
    ]);
