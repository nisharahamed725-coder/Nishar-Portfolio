            ...
            <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                        Hi, I'm <br />
                        <span className="text-gradient">Nishar Ahamed M</span>
                    </h1>
                    <p className="text-xl text-slate-400 mb-8 max-w-lg leading-relaxed">
                        Nishar Ahamed, a BCA student at EGS Pillay Arts and Science College, passionate about learning software development and building modern web applications. Focused on improving programming skills and exploring new technologies in the IT field.
                    </p>

                    <div className="flex flex-wrap gap-4 mb-10">
                        <Link to="education" smooth={true} offset={-100} className="px-8 py-3 bg-violet-600 hover:bg-violet-700 text-white rounded-lg font-medium transition-all shadow-lg shadow-violet-600/20 cursor-pointer">
                            View Education
                        </Link>
                ...
                >
                    ...
                    <div className="w-full h-[500px] border border-slate-800 bg-slate-900/50 rounded-2xl relative overflow-hidden group">
                        ...
                        <div className="p-6 font-mono text-sm space-y-4 text-slate-400">
                            ...
                            <div className="pl-6">
                                <span className="text-slate-500">name:</span> <span className="text-green-400">'Nishar Ahamed'</span>,
                            </div>
                            <div className="pl-6">
                                <span className="text-slate-500">role:</span> <span className="text-green-400">'BCA Student | Aspiring Software Developer'</span>,
                            </div>
                            <div className="pl-6">
                                <span className="text-slate-500">education:</span> <span className="text-orange-400">BCA - EGS Pillay Arts and Science College</span>,
                            </div>
                            <div className="pl-6">
                                <span className="text-slate-500">skills:</span> <span className="text-yellow-400">['C', 'C++', 'Java', 'HTML']</span>,
                            </div>
                            <div className="pl-6">
<span className="text-slate-500">currentFocus:</span> <span className="text-green-400">'Learning Programming & Software Development'</span>                            </div>
                            <div>
